...
exports.selectList = () => {
    return `Select id, personalId, fullName
            from User`
};
...
exports.selectListPersonalIds = () => {
    return `Select id, personalId, password, isAdmin
            from User
            WHERE personalId = ?`
};
...
exports.selectById = () => {
    return `Select id, personalId, fullName, password
            from User
            WHERE id = ?`
};

exports.selectByEmail = () => {
    return `Select id, user, email, is_admin
            From User
            WHERE password = ?
              AND email = ?`
};
